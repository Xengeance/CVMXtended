...
public class ModVehicleProperties {
    ...
    public static void register()
    {
        ...
        properties.setHeldOffset(new Vector3d(0.0, 3.5, 0.0));
        properties.setDisplayPosition(new PartPosition(0.0F, 0.0F, 0.1F, 0.0F, 0.0F, 0.0F, 0.55F));
        properties.addWheel(Wheel.Side.LEFT, Wheel.Position.FRONT, 8.0F, 9.0F, 2F, true, true);
        properties.addWheel(Wheel.Side.RIGHT, Wheel.Position.FRONT, 8.0F, 9.0F, 2F, true, true);
        properties.addWheel(Wheel.Side.LEFT, Wheel.Position.REAR, 8.0F, -16.0F, 2F, true, true);
        properties.addWheel(Wheel.Side.RIGHT, Wheel.Position.REAR, 8.0F, -16.0F, 2F, true, true);
        properties.setFrontAxelVec(0, 9);
        properties.setRearAxelVec(0, -16);
        properties.addSeat(new Seat(new Vector3d(0, 12, -3), true));
        VehicleProperties.setProperties(ModEntities.Loader.get(), properties);
    }
}
